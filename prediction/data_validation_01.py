...
import sys
import utility
from utility import read_prediction_schema
import os
import argparse
import ast
...
class Data_Validation:
    ...
    def move_to_bad_archive_directory(self,file_path:str):
        ...
        """
        try:
            Bad_Data_Directory = self.__config['artifacts']['Data_Directories']['prediction']['Bad_Data_Directory']
    ...
    def copy_to_good_data_directory(self, file_path: str):
        ...
        """
        try:
            Good_Data_Directory = self.__config['artifacts']['Data_Directories']['prediction']['Good_Data_Directory']
    ...
    def validate_column_names(self, df, file_path):
        ...
        LengthOfDateStampInFile, LengthOfTimeStampInFile, NumberofColumns, ColName = read_prediction_schema()
        if list(ColName.keys()) != df_columns:
            print("ColName.keys()", ColName.keys())
    ...
    for file_name in os.listdir(datasource):
        if file_name.endswith(".csv"):
            ...
            if data_validation.validate_file_name( file_name, file_path):
                ...
                )['artifacts']['Data_Directories']['prediction']['Good_Data_Directory']
...
if __name__=='__main__':
    ...
    args.add_argument("--data_source", default=os.path.join(os.getcwd(),
